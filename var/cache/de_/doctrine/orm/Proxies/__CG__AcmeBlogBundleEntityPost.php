 ...
 */
class Post extends \Acme\BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\BlogBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Acme\\BlogBundle\\Entity\\Post' . "\0" . 'tittle', '' . "\0" . 'Acme\\BlogBundle\\Entity\\Post' . "\0" . 'body', '' . "\0" . 'Acme\\BlogBundle\\Entity\\Post' . "\0" . 'publishedAt');
        }
