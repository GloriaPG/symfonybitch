...
class ap_DevProjectContainer extends Container
{
    private $parameters;
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_1' => 'get74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b361Service',
            '74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_2' => 'get74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b362Service',
            '74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_3' => 'get74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b363Service',
            ...
            'd991256170f93cf3adc3bdae6649fcd30f22044f4354837ccb1794a5c247e1f5_1' => 'getD991256170f93cf3adc3bdae6649fcd30f22044f4354837ccb1794a5c247e1f51Service',
    ...
    protected function get74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b361Service()
    {
        return $this->services['74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }
    protected function get74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b362Service()
    {
        return $this->services['74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }
    protected function get74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b363Service()
    {
        return $this->services['74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Applications/MAMP/htdocs/symfonybitch/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/MAMP/htdocs/symfonybitch/app/Resources');
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    protected function getD991256170f93cf3adc3bdae6649fcd30f22044f4354837ccb1794a5c247e1f51Service()
    {
        return $this->services['d991256170f93cf3adc3bdae6649fcd30f22044f4354837ccb1794a5c247e1f5_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_d8b6226366d30ed2d0a342e12edb6358f90a891a4112a1c4a6dc69912d6fc8ca');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d8b6226366d30ed2d0a342e12edb6358f90a891a4112a1c4a6dc69912d6fc8ca');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d8b6226366d30ed2d0a342e12edb6358f90a891a4112a1c4a6dc69912d6fc8ca');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Applications/MAMP/htdocs/symfonybitch/src/Acme/BlogBundle/Entity')), 'Acme\\BlogBundle\\Entity');
        ...
        $e->setProxyDir('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/MAMP/htdocs/symfonybitch/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('d991256170f93cf3adc3bdae6649fcd30f22044f4354837ccb1794a5c247e1f5_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/MAMP/htdocs/symfonybitch/app/../var/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/profiler', '', '', 86400), $a);
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/MAMP/htdocs/symfonybitch/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_1'), 1 => $this->get('74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_2'), 2 => $this->get('74a25e54e5e8cebbe0f1ffa97543b8a0a3f10803f2dce82756c2528b64792b36_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/MAMP/htdocs/symfonybitch/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/MAMP/htdocs/symfonybitch/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/src/Acme/BlogBundle/Resources/views', 'AcmeBlog');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/app/Resources/views');
        $instance->addPath('/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/MAMP/htdocs/symfonybitch/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/MAMP/htdocs/symfonybitch/app/../web', false);
        $instance->addWorker(new \Symfony\Bundle\AsseticBundle\Factory\Worker\UseControllerWorker());
        return $instance;
    }
    protected function getAssetic_CacheService()
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/symfonybitch/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/logs',
            ...
            'kernel.container_class' => 'ap_DevProjectContainer',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/assetic',
            ...
            'assetic.read_from' => '/Applications/MAMP/htdocs/symfonybitch/app/../web',
            'assetic.write_to' => '/Applications/MAMP/htdocs/symfonybitch/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/de_/doctrine/orm/Proxies',
