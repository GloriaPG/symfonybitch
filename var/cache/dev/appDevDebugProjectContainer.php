...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '6aa8e6513b916e902f8bfe2c0f15fe72032f8009044a37f2cfea103af8fc139e_1' => 'get6aa8e6513b916e902f8bfe2c0f15fe72032f8009044a37f2cfea103af8fc139e1Service',
            ...
            'b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_1' => 'getB67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe81Service',
            'b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_2' => 'getB67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe82Service',
            'b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_3' => 'getB67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe83Service',
    ...
    /**
     * Gets the '6aa8e6513b916e902f8bfe2c0f15fe72032f8009044a37f2cfea103af8fc139e_1' service.
     *
     ...
     */
    protected function get6aa8e6513b916e902f8bfe2c0f15fe72032f8009044a37f2cfea103af8fc139e1Service()
    {
        return $this->services['6aa8e6513b916e902f8bfe2c0f15fe72032f8009044a37f2cfea103af8fc139e_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/test/app/../var/cache/dev/annotations', true);
    }
    ...
    /**
     * Gets the 'b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe81Service()
    {
        return $this->services['b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe82Service()
    {
        return $this->services['b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getB67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe83Service()
    {
        return $this->services['b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/MAMP/htdocs/test/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_e3404d6e2fa25c2031ad9c4c5d6ce44b0aa9dc3bb72852eae35479b9f342f160');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e3404d6e2fa25c2031ad9c4c5d6ce44b0aa9dc3bb72852eae35479b9f342f160');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e3404d6e2fa25c2031ad9c4c5d6ce44b0aa9dc3bb72852eae35479b9f342f160');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Applications/MAMP/htdocs/test/src/Acme/BlogBundle/Entity')), 'Acme\\BlogBundle\\Entity');
        ...
        $e->setProxyDir('/Applications/MAMP/htdocs/test/app/../var/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/MAMP/htdocs/test/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('6aa8e6513b916e902f8bfe2c0f15fe72032f8009044a37f2cfea103af8fc139e_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/MAMP/htdocs/test/app/../var/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/test/app/../var/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/MAMP/htdocs/test/app/../var/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/test/app/../var/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/MAMP/htdocs/test/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/test/app/../var/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_1'), 1 => $this->get('b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_2'), 2 => $this->get('b67789d3ba9af0f65383482c3af65f9898092c0099ca559bb2d682d94237dfe8_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/MAMP/htdocs/test/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/MAMP/htdocs/test/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/MAMP/htdocs/test/src/Acme/BlogBundle/Resources/views', 'AcmeBlog');
        $instance->addPath('/Applications/MAMP/htdocs/test/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/MAMP/htdocs/test/app/Resources/views');
        $instance->addPath('/Applications/MAMP/htdocs/test/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/MAMP/htdocs/test/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/MAMP/htdocs/test/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/test/app/../var/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/test/app/../var/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/test/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/test/app/../var/logs',
            ...
            'debug.container.dump' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/test/app/../var/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/MAMP/htdocs/test/app/../web',
            'assetic.write_to' => '/Applications/MAMP/htdocs/test/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/test/app/../var/cache/dev/doctrine/orm/Proxies',
