...
class appDevProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->setProxyDir('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/profiler', '', '', 86400), $a);
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/symfonybitch/app/../var/cache/dev/doctrine/orm/Proxies',
